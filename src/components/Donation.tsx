...
export function Donation() {
  return (
    <section id="support" className="relative overflow-hidden text-white bg-charcoal">


      {/* Gold top border line */}
      <div className="h-px w-full" style={{ background: 'linear-gradient(to right, transparent, #C4884A, transparent)' }} />
      ...
      <div className="relative max-w-6xl mx-auto px-6 sm:px-10 py-20 sm:py-32">
        ...
        <FadeIn variant="reveal">
          <div className="flex items-center gap-4 mb-8">
            <div className="h-px w-10" style={{ background: 'linear-gradient(to right, #C4884A, transparent)' }} />
            <span className="font-sans text-[9px] uppercase tracking-[0.5em]" style={{ color: '#C4884A' }}>
              Support the Mission
            </span>
          </div>
        </FadeIn>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div>
            ...
            >
              Sustain<br />
              <span style={{ color: '#C4884A' }}>the Light</span><br />
              to Mankind
            </motion.h2>
            ...
            <div className="space-y-6 mt-10">
              {microStats.map((s, i) => (
                <motion.div
                  ...
                  style={{ borderColor: 'rgba(196,136,74,0.20)' }}
                >
                  <div className="font-serif text-4xl sm:text-5xl font-light shrink-0" style={{ color: '#C4884A' }}>
          ...
          <motion.div
            ...
            className="lg:pt-6"
          >
            <blockquote className="border-l-2 pl-6 mb-10" style={{ borderColor: '#C4884A' }}>
